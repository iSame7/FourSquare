//
//  PhotosInteractionAnimator.swift
//  FourSquare
//
...
public class PhotoInteractionAnimator: NSObject, UIViewControllerInteractiveTransitioning {
    ...
    func finishPanWithPanGestureRecognizer(_ gestureRecognizer: UIPanGestureRecognizer, verticalDelta: CGFloat, viewToPan: UIView, anchorPoint: CGPoint) {
        ...
        if isDismissing {
            if let animator = animator, let transitionContext = transitionContext , shouldAnimateUsingAnimator {
